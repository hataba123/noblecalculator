    ...
    tools: {
      ...
      groups: {
        health: {
          ...
          description: "Track body metrics and healthy ranges before setting a fitness goal.",
        },
        pricing: {
    ...
    tools: {
      ...
      groups: {
        health: {
          ...
          description: "Haz seguimiento de métricas corporales y rangos saludables antes de fijar una meta de fitness.",
        },
        pricing: {
