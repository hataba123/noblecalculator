...
const uiMessages = {
  en: {
    ...
    home: {
      ...
      whyTitle: "Quick answers for pricing, taxes, and everyday planning.",
      whyDescription:
        "Each calculator gives you a fast starting point with clear steps, simple explanations, and results you can act on right away.",
      whyCardOne: "Use them when you need a quote, a tax check, or a quick sanity check before you decide.",
      whyCardTwo: "Move between tools without losing your place or re-entering everything.",
      goodFor: "Helpful for",
      goodForItems: [
        "Freelance quotes",
        "Invoices and tax planning",
  ...
  es: {
    ...
    home: {
      ...
      whyTitle: "Respuestas rápidas para precios, impuestos y planificación diaria.",
      whyDescription:
        "Cada calculadora te da un punto de partida rápido con pasos claros, explicaciones simples y resultados que puedes usar de inmediato.",
      whyCardOne: "Úsalas cuando necesites un presupuesto, una revisión de impuestos o una comprobación rápida antes de decidir.",
      whyCardTwo: "Pasa de una herramienta a otra sin perder tu lugar ni volver a escribir todo.",
      goodFor: "Útil para",
      goodForItems: [
        "Presupuestos freelance",
        "Facturas y planeación de impuestos",
        "Revisión de gasto publicitario y ROI",
        "Planeación de presupuesto web",
      ],
      featuredTools: [
