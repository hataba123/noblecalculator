    ...
    <header className="relative z-40 border-b border-[color:var(--border)] bg-[color:var(--background)]/90 backdrop-blur sm:sticky sm:top-0 sm:z-20">
      <div className="mx-auto flex w-full max-w-[90rem] flex-col gap-3 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8 xl:px-10">
        ...
        <nav className="grid w-full grid-cols-4 gap-1.5 text-[0.72rem] font-medium leading-none text-[color:var(--foreground)] sm:flex sm:w-auto sm:flex-wrap sm:items-center sm:justify-end sm:gap-2 sm:text-base sm:leading-normal lg:text-lg">
          <Link href={homeHref} className="inline-flex w-full min-w-0 items-center justify-center whitespace-nowrap rounded-xl px-1.5 py-2 text-center transition-all duration-150 ease-out hover:bg-[color:var(--surface-soft)] active:translate-y-[1px] active:scale-[0.98] sm:w-auto sm:px-4">
            {t("navigation.home")}
          </Link>
          <Link href={toolsHref} className="inline-flex w-full min-w-0 items-center justify-center whitespace-nowrap rounded-xl px-1.5 py-2 text-center transition-all duration-150 ease-out hover:bg-[color:var(--surface-soft)] active:translate-y-[1px] active:scale-[0.98] sm:w-auto sm:px-4">
          ...
          <div ref={languageMenuRef} className="relative justify-self-stretch sm:justify-self-auto">
            <button
              ...
              className="inline-flex w-full min-w-0 items-center justify-between gap-1.5 rounded-xl border border-[color:var(--border)] bg-[color:var(--surface)] px-2.5 py-2 text-[0.72rem] font-semibold leading-none text-[color:var(--foreground)] shadow-[0_8px_18px_rgba(34,24,12,0.08)] transition-all duration-150 ease-out hover:-translate-y-0.5 hover:bg-[color:var(--surface-soft)] active:translate-y-[1px] active:scale-[0.98] sm:w-auto sm:gap-2 sm:px-4 sm:text-sm sm:leading-normal"
            >
              <span className="sm:hidden">{locale === "es" ? "ES" : "EN"}</span>
            ...
            <div
              ...
              className={`absolute right-0 top-[calc(100%+0.5rem)] z-50 w-[min(12rem,calc(100vw-2rem))] overflow-hidden rounded-[0.95rem] border border-[color:var(--border)] bg-[color:var(--surface)] p-1 shadow-[0_20px_48px_rgba(34,24,12,0.16)] transition-all duration-150 ease-out ${
                isLanguageMenuOpen
