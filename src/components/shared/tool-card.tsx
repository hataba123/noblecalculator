    ...
    >
      ...
      <div className="mt-5 flex flex-1 items-end justify-end gap-3 sm:mt-6">
        <Link
          ...
          className={
            isDark
              ? "tool-card-open-btn rounded-full border border-white/10 bg-white/10 px-4 py-2 text-sm font-semibold text-[color:var(--foreground)] transition-colors hover:bg-white/12 active:scale-[0.98]"
              : "tool-card-open-btn rounded-full border border-[color:var(--accent-strong)] bg-[color:var(--accent-strong)] px-4 py-2 text-sm font-semibold text-[color:var(--background)] transition-colors hover:bg-black active:scale-[0.98]"
          }
        >
          Open
        </Link>
